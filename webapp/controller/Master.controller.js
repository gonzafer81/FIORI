...
sap.ui.define([
		...
		"ZFER02_FRAGMENTS/ZFER02_FRAGMENTS/model/grouper",
		...
		return BaseController.extend("ZFER02_FRAGMENTS.ZFER02_FRAGMENTS.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("ZFER02_FRAGMENTS.ZFER02_FRAGMENTS.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("PriorityNumber", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("PriorityNumber", FilterOperator.GT, 100));
							break;
						default :
							break;
					}

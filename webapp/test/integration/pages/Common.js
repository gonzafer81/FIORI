sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ZFER02_FRAGMENTS/ZFER02_FRAGMENTS/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("ZFER02_FRAGMENTS.ZFER02_FRAGMENTS.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ZFER02_FRAGMENTS/ZFER02_FRAGMENTS/localService/mockserver"], function (mockserver) {

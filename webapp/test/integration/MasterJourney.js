...
sap.ui.define([
	...
	opaTest("MasterList Filtering on PriorityNumber less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<PriorityNumber>").
	...
	opaTest("MasterList Filtering on PriorityNumber more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <>").
			and.iPressOKInViewSelectionDialog();
